...
function Calendarize() {
	var monthNames = ["Január", "Február", "Marec", "Apríľ", "Máj", "Jún", "Júl", "August", "September", "Octóber", "November", "December"];
	...
	return {
		...
		buildMonth: function(monthNum, year, opts) {
			...
			var skipLength = daysInMonth[6].getDay();  // 6 zmenil Vrťo z hodnoty 0 pre americký formát týždňa
			...
			if (opts.showMonth) {
                ...
                $titleNode.classList.add('text-warning');
